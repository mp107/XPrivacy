...
public class XBinder extends XHook {
	...
	private static Map<String, Boolean> mMapClassSystem = new HashMap<>();
	private static Map<String, SparseArray<String>> mMapCodeName = new HashMap<>();
	...
	// @formatter:off
	public static List<String> cServiceOptional = Arrays.asList("<noname>",
			"iphonesubinfo",
			"iphonesubinfo_msim",
			"sip",
			"isms",
