	...
	protected void onPostExecute(Object result) {
		if (!mContext.isFinishing()) {
			...
			if (mListWhitelist.keySet().size() > 0) {
				...
				int index = 0;
				int selected = -1;
				final List<String> localizedType = new ArrayList<>();
				...
				Spinner spWhitelistType = llWhitelists.findViewById(R.id.spWhitelistType);
				ArrayAdapter<String> whitelistTypeAdapter = new ArrayAdapter<>(mContext,
				...
				ListView lvWhitelist = llWhitelists.findViewById(R.id.lvWhitelist);
