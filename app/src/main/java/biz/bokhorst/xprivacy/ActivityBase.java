	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!PrivacyService.checkClient()) {
			...
			if (PrivacyService.getClient() == null) {
				findViewById(R.id.tvRebootClient).setVisibility(View.VISIBLE);
				Requirements.checkCompatibility(this);
			} else {
				findViewById(R.id.tvRebootVersion).setVisibility(View.VISIBLE);
				Requirements.check(this);
			}

			// Show if updating
			if (isUpdating())
				findViewById(R.id.tvServiceUpdating).setVisibility(View.VISIBLE);
		}
	}
